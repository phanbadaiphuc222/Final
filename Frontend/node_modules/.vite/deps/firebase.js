import "./chunk-WHZZPO4M.js";
import {
  Vc,
  qc,
  wc
} from "./chunk-IWUPGIOM.js";
import {
  deleteDb,
  openDb
} from "./chunk-G4QUVS33.js";
import {
  Component,
  ComponentContainer,
  Deferred,
...
var DOMStorageWrapper = function() {
  ...
  DOMStorageWrapper2.prototype.prefixedName_ = function(name7) {
...
var StatsCollection = function() {
  ...
  StatsCollection2.prototype.incrementCounter = function(name7, amount) {
    if (amount === void 0) {
      amount = 1;
    }
  ...
  BrowserPollConnection2.prototype.open = function(onMessage, onDisconnect) {
    ...
    executeWhenDOMReady(function() {
      ...
      _this.scriptTagHolder = new FirebaseIFrameScriptHolder(function() {
        ...
        var _a4 = __read(args, 5), command = _a4[0], arg1 = _a4[1], arg2 = _a4[2], arg3 = _a4[3], arg4 = _a4[4];
        ...
        var _a4 = __read(args, 2), pN = _a4[0], data = _a4[1];
        _this.incrementIncomingBytes_(args);
...
var NamedNode = function() {
  function NamedNode2(name7, node) {
    this.name = name7;
    this.node = node;
  }
  NamedNode2.Wrap = function(name7, node) {
...
var KeyIndex = function(_super) {
  ...
  KeyIndex2.prototype.makePost = function(indexValue, name7) {
...
var PriorityIndex = function(_super) {
  ...
  PriorityIndex2.prototype.makePost = function(indexValue, name7) {
...
var PathIndex = function(_super) {
  ...
  PathIndex2.prototype.makePost = function(indexValue, name7) {
...
var ValueIndex = function(_super) {
  ...
  ValueIndex2.prototype.makePost = function(indexValue, name7) {
    var valueNode = nodeFromJSON$1(indexValue);
...
function viewProcessorAckUserWrite(viewProcessor, viewCache, ackPath, affectedTree, writesCache, completeCache, accumulator) {
  ...
  if (affectedTree.value != null) {
    if (pathIsEmpty(ackPath) && serverCache.isFullyInitialized() || serverCache.isCompleteForPath(ackPath)) {
      ...
      serverCache.getNode().forEachChild(KEY_INDEX, function(name7, node) {
        changedChildren_1 = changedChildren_1.set(new Path(name7), node);
      });
...
var Tree = function() {
  function Tree2(name7, parent2, node) {
    if (name7 === void 0) {
      name7 = "";
    }
    if (parent2 === void 0) {
...
var Query = function() {
  function Query2(database, path, queryParams_, orderByCalled_) {
  ...
  Query2.prototype.getRef = function() {
    ...
    return new Query2.__referenceConstructor(this.database, this.path);
  };
  ...
  Query2.prototype.limitToFirst = function(limit) {
    ...
    return new Query2(this.database, this.path, queryParamsLimitToFirst(this.queryParams_, limit), this.orderByCalled_);
  };
  Query2.prototype.limitToLast = function(limit) {
    ...
    return new Query2(this.database, this.path, queryParamsLimitToLast(this.queryParams_, limit), this.orderByCalled_);
  };
  ...
  Query2.prototype.startAt = function(value, name7) {
    if (value === void 0) {
      value = null;
    }
    validateArgCount("Query.startAt", 0, 2, arguments.length);
    validateFirebaseDataArg("Query.startAt", 1, value, this.path, true);
    validateKey("Query.startAt", 2, name7, true);
    var newParams = queryParamsStartAt(this.queryParams_, value, name7);
    ...
    return new Query2(this.database, this.path, newParams, this.orderByCalled_);
  };
  Query2.prototype.startAfter = function(value, name7) {
    if (value === void 0) {
      value = null;
    }
    validateArgCount("Query.startAfter", 0, 2, arguments.length);
    validateFirebaseDataArg("Query.startAfter", 1, value, this.path, false);
    validateKey("Query.startAfter", 2, name7, true);
    var newParams = queryParamsStartAfter(this.queryParams_, value, name7);
    Query2.validateLimit_(newParams);
    Query2.validateQueryEndpoints_(newParams);
    if (this.queryParams_.hasStart()) {
  ...
  Query2.prototype.endAt = function(value, name7) {
    if (value === void 0) {
      value = null;
    }
    validateArgCount("Query.endAt", 0, 2, arguments.length);
    validateFirebaseDataArg("Query.endAt", 1, value, this.path, true);
    validateKey("Query.endAt", 2, name7, true);
    var newParams = queryParamsEndAt(this.queryParams_, value, name7);
    Query2.validateLimit_(newParams);
    Query2.validateQueryEndpoints_(newParams);
  ...
  Query2.prototype.endBefore = function(value, name7) {
    if (value === void 0) {
      value = null;
    }
    validateArgCount("Query.endBefore", 0, 2, arguments.length);
    validateFirebaseDataArg("Query.endBefore", 1, value, this.path, false);
    validateKey("Query.endBefore", 2, name7, true);
    var newParams = queryParamsEndBefore(this.queryParams_, value, name7);
    Query2.validateLimit_(newParams);
    Query2.validateQueryEndpoints_(newParams);
    if (this.queryParams_.hasEnd()) {
  ...
  Query2.prototype.equalTo = function(value, name7) {
    validateArgCount("Query.equalTo", 1, 2, arguments.length);
    validateFirebaseDataArg("Query.equalTo", 1, value, this.path, false);
    validateKey("Query.equalTo", 2, name7, true);
    if (this.queryParams_.hasStart()) {
    ...
    return this.startAt(value, name7).endAt(value, name7);
  };
...
var Reference = function(_super) {
  ...
  function Reference3(database, path) {
  ...
  Reference3.prototype.child = function(pathString) {
    ...
    return new Reference3(this.database, pathChild(this.path, pathString));
  };
  Reference3.prototype.getParent = function() {
    validateArgCount("Reference.parent", 0, 0, arguments.length);
    var parentPath = pathParent(this.path);
    return parentPath === null ? null : new Reference3(this.database, parentPath);
  };
  ...
  Reference3.prototype.transaction = function(transactionUpdate, onComplete, applyLocally) {
    ...
    var promiseComplete = function(error2, committed, node) {
      if (error2) {
        ...
        if (typeof onComplete === "function") {
          onComplete(error2, committed, null);
        }
      } else {
        var snapshot = new DataSnapshot(node, new Reference3(_this.database, _this.path), PRIORITY_INDEX);
    ...
    var watchRef = new Reference3(this.database, this.path);
  ...
  Reference3.prototype.push = function(value, onComplete) {
    ...
    var name7 = nextPushId(now);
    var thennablePushRef = this.child(name7);
    var pushRef = this.child(name7);
    var promise;
    if (value != null) {
...
function initStandalone(_a4) {
  var app = _a4.app, url = _a4.url, version7 = _a4.version, customAuthImpl = _a4.customAuthImpl, namespace = _a4.namespace, _b = _a4.nodeAdmin, nodeAdmin = _b === void 0 ? false : _b;
  setSDKVersion(version7);
...
function registerDatabase(instance) {
  ...
  var namespace = instance.INTERNAL.registerComponent(new Component("database", function(container, _a4) {
    var url = _a4.instanceIdentifier;
...
function t(o) {
  o.prototype.loadBundle = Vc, o.prototype.namedQuery = qc;
}
t(wc);
...
var Service = function() {
  ...
  Service2.prototype._url = function(name7) {
    var projectId = this.app_.options.projectId;
    if (this.emulatorOrigin !== null) {
      var origin_1 = this.emulatorOrigin;
      return origin_1 + "/" + projectId + "/" + this.region + "/" + name7;
    }
  ...
  Service2.prototype.httpsCallable = function(name7, options) {
    var _this = this;
    return function(data) {
      return _this.call(name7, data, options || {});
    };
  };
  ...
  Service2.prototype.call = function(name7, data, options) {
    return __awaiter(this, void 0, void 0, function() {
      var url, body, headers, context, timeout, _a4, timer, failAfterPromise, response, error2, responseData, decodedData;
      return __generator(this, function(_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            _a4 = failAfter(timeout), timer = _a4.timer, failAfterPromise = _a4.promise;
...
function registerFunctions(instance, fetchImpl) {
  ...
  function factory2(container, _a4) {
    var regionOrCustomDomain = _a4.instanceIdentifier;
    var app = container.getProvider("app").getImmediate();
    var authProvider = container.getProvider("auth-internal");
                  ...
                  case 2:
                    ...
                    if (db2.oldVersion === 2) {
                      ...
                      tokenDetails = {
                        ...
                        createTime: (_a5 = oldDetails.createTime) !== null && _a5 !== void 0 ? _a5 : Date.now(),
                        subscriptionOptions: {
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(_a4) {
      switch (_a4.label) {
        ...
        case 1:
          db = _a4.sent();
          return [4, db.transaction(OBJECT_STORE_NAME).objectStore(OBJECT_STORE_NAME).get(key)];
        case 2:
          tokenDetails = _a4.sent();
          if (!tokenDetails)
            return [3, 3];
    ...
    return __generator(this, function(_a4) {
      switch (_a4.label) {
        ...
        case 1:
          ...
          return [4, tx.objectStore(OBJECT_STORE_NAME).put(tokenDetails, key)];
        case 2:
          _a4.sent();
...
function requestGetToken(firebaseDependencies, subscriptionOptions) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(_a4) {
      switch (_a4.label) {
        case 0:
          return [4, getHeaders(firebaseDependencies)];
        case 1:
          headers = _a4.sent();
...
function getEndpoint(_a4) {
  var projectId = _a4.projectId;
  return ENDPOINT + "/projects/" + projectId + "/registrations";
}
function getHeaders(_a4) {
  var appConfig = _a4.appConfig, installations = _a4.installations;
  return __awaiter(this, void 0, void 0, function() {
    var authToken;
    return __generator(this, function(_b) {
      switch (_b.label) {
...
function getBody(_a4) {
  var p256dh = _a4.p256dh, auth = _a4.auth, endpoint = _a4.endpoint, vapidKey = _a4.vapidKey;
  var body = {
    web: {
      endpoint,
      auth,
      ...
      return __generator(this, function(_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            this.vapidKey = (_b = (_a4 = tokenDetails === null || tokenDetails === void 0 ? void 0 : tokenDetails.subscriptionOptions) === null || _a4 === void 0 ? void 0 : _a4.vapidKey) !== null && _b !== void 0 ? _b : DEFAULT_VAPID_KEY;
            _c.label = 2;
          case 2:
            return [2, getToken(this.firebaseDependencies, self.registration, this.vapidKey)];
        }
      });
    });
  };
      ...
      return __generator(this, function(_a4) {
        switch (_a4.label) {
          ...
          case 3:
            ...
            return [4, sleep(BACKGROUND_HANDLE_EXECUTION_TIME_LIMIT_MS)];
          case 4:
            _a4.sent();
            return [2];
        }
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_c) {
        switch (_c.label) {
          ...
          case 4:
            _c.sent();
            return [4, getToken(this.firebaseDependencies, self.registration, (_b = (_a4 = tokenDetails === null || tokenDetails === void 0 ? void 0 : tokenDetails.subscriptionOptions) === null || _a4 === void 0 ? void 0 : _a4.vapidKey) !== null && _b !== void 0 ? _b : DEFAULT_VAPID_KEY)];
          case 5:
            _c.sent();
            return [2];
        }
  ...
  SwController2.prototype.onNotificationClick = function(event) {
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_c) {
        switch (_c.label) {
          case 0:
            internalPayload = (_b = (_a4 = event.notification) === null || _a4 === void 0 ? void 0 : _a4.data) === null || _b === void 0 ? void 0 : _b[FCM_MSG];
            if (!internalPayload) {
              return [2];
          ...
          case 2:
            client = _c.sent();
            return [4, sleep(FOREGROUND_HANDLE_PREPARATION_TIME_MS)];
          case 3:
            _c.sent();
            return [3, 6];
          case 4:
...
function wrapInternalPayload(internalPayload) {
  ...
  wrappedInternalPayload.data = (_a4 = {}, _a4[FCM_MSG] = internalPayload, _a4);
  return wrappedInternalPayload;
}
function getMessagePayloadInternal(_a4) {
  var data = _a4.data;
  if (!data) {
    return null;
  }
      ...
      switch (_b.label) {
        ...
        case 1:
          ...
          try {
            ...
            try {
              if (clientList_1_1 && !clientList_1_1.done && (_a4 = clientList_1.return))
                _a4.call(clientList_1);
            } finally {
              if (e_1)
                throw e_1.error;
            }
...
function sendMessagePayloadInternalToWindows(clientList, internalPayload) {
  ...
  try {
    ...
    try {
      if (clientList_2_1 && !clientList_2_1.done && (_a4 = clientList_2.return))
        _a4.call(clientList_2);
    } finally {
      if (e_2)
        throw e_2.error;
    }
...
function showNotification(notificationPayloadInternal) {
  ...
  return self.registration.showNotification(
    (_a4 = notificationPayloadInternal.title) !== null && _a4 !== void 0 ? _a4 : "",
    notificationPayloadInternal
  );
}
function getLink(payload) {
  var _a4, _b, _c;
  var link = (_b = (_a4 = payload.fcmOptions) === null || _a4 === void 0 ? void 0 : _a4.link) !== null && _b !== void 0 ? _b : (_c = payload.notification) === null || _c === void 0 ? void 0 : _c.click_action;
  if (link) {
    return link;
  }
    ...
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(_a4) {
        switch (_a4.label) {
          ...
          case 4:
            _a4.sent();
            return [2, getToken(this.firebaseDependencies, this.swRegistration, this.vapidKey)];
        }
      });
    });
  };
...
function extractAppConfig(app) {
  ...
  try {
    ...
    try {
      if (configKeys_1_1 && !configKeys_1_1.done && (_a4 = configKeys_1.return))
        _a4.call(configKeys_1);
    } finally {
      if (e_1)
        throw e_1.error;
    }
...
function invalidRootOperation(name7) {
  return new FirebaseStorageError("invalid-root-operation", "The operation '" + name7 + "' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').");
}
...
var Location = function() {
  ...
  Location2.makeFromUrl = function(url) {
    ...
    var version7 = "v[A-Za-z0-9_]+";
    var firebaseStorageHost = DEFAULT_HOST.replace(/[.]/g, "\\.");
    var firebaseStoragePath = "(/([^?#]*).*)?$";
    var firebaseStorageRegExp = new RegExp("^https?://" + firebaseStorageHost + "/" + version7 + "/b/" + bucketDomain + "/o" + firebaseStoragePath, "i");
...
function fromBackendResponse(service, bucket, resource) {
  ...
  if (resource[PREFIXES_KEY]) {
    for (var _i = 0, _a4 = resource[PREFIXES_KEY]; _i < _a4.length; _i++) {
      var path = _a4[_i];
...
var Reference2 = function() {
  ...
  Reference3.prototype._throwIfRoot = function(name7) {
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(_c) {
      switch (_c.label) {
        ...
        case 1:
          nextPage = _c.sent();
          (_a4 = accumulator.prefixes).push.apply(_a4, nextPage.prefixes);
...
var ReferenceCompat = function() {
  ...
  ReferenceCompat2.prototype._throwIfRoot = function(name7) {
...
function factory(container, _a4) {
  var url = _a4.instanceIdentifier;
  var app = container.getProvider("app").getImmediate();
  var authProvider = container.getProvider("auth-internal");
...
var _a2;
var ERROR_DESCRIPTION_MAP = (_a2 = {}, _a2["trace started"] = "Trace {$traceName} was started before.", _a2["trace stopped"] = "Trace {$traceName} is not running.", _a2["nonpositive trace startTime"] = "Trace {$traceName} startTime should be positive.", _a2["nonpositive trace duration"] = "Trace {$traceName} duration should be positive.", _a2["no window"] = "Window is not available.", _a2["no app id"] = "App id is not available.", _a2["no project id"] = "Project id is not available.", _a2["no api key"] = "Api key is not available.", _a2["invalid cc log"] = "Attempted to queue invalid cc event", _a2["FB not default"] = "Performance can only start when Firebase app instance is the default one.", _a2["RC response not ok"] = "RC response is not ok", _a2["invalid attribute name"] = "Attribute name {$attributeName} is invalid.", _a2["invalid attribute value"] = "Attribute value {$attributeValue} is invalid.", _a2["invalid custom metric name"] = "Custom metric name {$customMetricName} is invalid", _a2["invalid String merger input"] = "Input for String merger is invalid, contact support team to resolve.", _a2);
...
var Api = function() {
  function Api2(window2) {
    this.window = window2;
    if (!window2) {
      throw ERROR_FACTORY2.create("no window");
    }
  ...
  Api2.prototype.mark = function(name7) {
  ...
  Api2.prototype.getEntriesByName = function(name7) {
  ...
  Api2.prototype.setupObserver = function(entryType, callback) {
    ...
    var observer = new this.PerformanceObserver(function(list2) {
      for (var _i = 0, _a4 = list2.getEntries(); _i < _a4.length; _i++) {
        var entry = _a4[_i];
        callback(entry);
      }
    });
...
function mergeStrings(part1, part2) {
  ...
  if (sizeDiff < 0 || sizeDiff > 1) {
    throw ERROR_FACTORY2.create("invalid String merger input");
  }
  var resultArray = [];
...
var SettingsService = function() {
  ...
  SettingsService2.prototype.getProjectId = function() {
    ...
    if (!projectId) {
      throw ERROR_FACTORY2.create("no project id");
    }
    return projectId;
  };
...
function isValidCustomAttributeName(name7) {
  ...
  var matchesReservedPrefix = RESERVED_ATTRIBUTE_PREFIXES.some(function(prefix) {
    return name7.startsWith(prefix);
  });
...
function getRemoteConfig(iid2) {
  return getAuthTokenPromise().then(function(authToken) {
    ...
    return fetch(request).then(function(response) {
      ...
      throw ERROR_FACTORY2.create("RC response not ok");
    });
  }).catch(function() {
...
function addToQueue(evt) {
  if (!evt.eventTime || !evt.message) {
    throw ERROR_FACTORY2.create("invalid cc log");
  }
...
var Trace = function() {
  function Trace2(name7, isAuto, traceMeasureName) {
    if (isAuto === void 0) {
      isAuto = false;
    }
    this.name = name7;
  ...
  Trace2.prototype.record = function(startTime, duration, options) {
    ...
    if (options && options.metrics) {
      for (var _i = 0, _a4 = Object.keys(options.metrics); _i < _a4.length; _i++) {
        var metric = _a4[_i];
...
var PerformanceController = function() {
  ...
  PerformanceController2.prototype.trace = function(name7) {
    return new Trace(name7);
  };
...
function registerPerformance(instance) {
  var factoryMethod2 = function(app, installations) {
    if (app.name !== DEFAULT_ENTRY_NAME) {
      throw ERROR_FACTORY2.create("FB not default");
    }
...
var CachingClient = function() {
  function CachingClient2(client, storage, storageCache, logger3) {
    this.client = client;
    this.storage = storage;
  ...
  CachingClient2.prototype.fetch = function(request) {
    return __awaiter(this, void 0, void 0, function() {
      var _a4, lastSuccessfulFetchTimestampMillis, lastSuccessfulFetchResponse, response, storageOperations;
      return __generator(this, function(_b) {
        switch (_b.label) {
          case 0:
          ...
          case 1:
            _a4 = _b.sent(), lastSuccessfulFetchTimestampMillis = _a4[0], lastSuccessfulFetchResponse = _a4[1];
...
var _a3;
var ERROR_DESCRIPTION_MAP2 = (_a3 = {}, _a3["registration-window"] = "Undefined window object. This SDK only supports usage in a browser environment.", _a3["registration-project-id"] = "Undefined project identifier. Check Firebase app initialization.", _a3["registration-api-key"] = "Undefined API key. Check Firebase app initialization.", _a3["registration-app-id"] = "Undefined app identifier. Check Firebase app initialization.", _a3["storage-open"] = "Error thrown when opening storage. Original error: {$originalErrorMessage}.", _a3["storage-get"] = "Error thrown when reading from storage. Original error: {$originalErrorMessage}.", _a3["storage-set"] = "Error thrown when writing to storage. Original error: {$originalErrorMessage}.", _a3["storage-delete"] = "Error thrown when deleting from storage. Original error: {$originalErrorMessage}.", _a3["fetch-client-network"] = "Fetch client failed to connect to a network. Check Internet connection. Original error: {$originalErrorMessage}.", _a3["fetch-timeout"] = 'The config fetch request timed out.  Configure timeout using "fetchTimeoutMillis" SDK setting.', _a3["fetch-throttle"] = 'The config fetch request timed out while in an exponential backoff state. Configure timeout using "fetchTimeoutMillis" SDK setting. Unix timestamp in milliseconds when fetch request throttling ends: {$throttleEndTimeMillis}.', _a3["fetch-client-parse"] = "Fetch client could not parse response. Original error: {$originalErrorMessage}.", _a3["fetch-status"] = "Fetch server returned an HTTP error status. HTTP status: {$httpStatus}.", _a3);
...
var RestClient = function() {
  ...
  RestClient2.prototype.fetch = function(request) {
    return __awaiter(this, void 0, void 0, function() {
      var _a4, installationId, installationToken, urlBase, url, headers, requestBody, options, fetchPromise, timeoutPromise, response, originalError_1, errorCode, status, responseEtag, config, state, responseBody, originalError_2;
      return __generator(this, function(_b) {
        switch (_b.label) {
          case 0:
            return [4, Promise.all([
          ...
          case 1:
            _a4 = _b.sent(), installationId = _a4[0], installationToken = _a4[1];
...
var RemoteConfig = function() {
  ...
  RemoteConfig2.prototype.activate = function() {
    return __awaiter(this, void 0, void 0, function() {
      var _a4, lastSuccessfulFetchResponse, activeConfigEtag;
      return __generator(this, function(_b) {
        switch (_b.label) {
          case 0:
            return [4, Promise.all([
          ...
          case 1:
            _a4 = _b.sent(), lastSuccessfulFetchResponse = _a4[0], activeConfigEtag = _a4[1];
...
var RetryingClient = function() {
  ...
  RetryingClient2.prototype.attemptFetch = function(request, _a4) {
    var throttleEndTimeMillis = _a4.throttleEndTimeMillis, backoffCount = _a4.backoffCount;
    return __awaiter(this, void 0, void 0, function() {
      var response, e_1, throttleMetadata;
      return __generator(this, function(_b) {
        switch (_b.label) {
          case 0:
            return [4, setAbortableTimeout(request.signal, throttleEndTimeMillis)];
          case 1:
            _b.sent();
            _b.label = 2;
          case 2:
...
function registerRemoteConfig(firebaseInstance) {
  ...
  firebaseInstance.registerVersion(name5, version5);
  function remoteConfigFactory(container, _a4) {
    var namespace = _a4.instanceIdentifier;
    var app = container.getProvider("app").getImmediate();
    var installations = container.getProvider("installations").getImmediate();
    if (typeof window === "undefined") {
    ...
    var cachingClient = new CachingClient(retryingClient, storage, storageCache, logger3);
    var remoteConfigInstance = new RemoteConfig(app, cachingClient, storageCache, storage, logger3);
...
var name6 = "firebase";
var version6 = "8.3.2";
index_esm_default.registerVersion(name6, version6, "app");
var name$1 = "firebase";
var version$1 = "8.3.2";
console.warn("\nIt looks like you're using the development build of the Firebase JS SDK.\nWhen deploying Firebase apps to production, it is advisable to only import\nthe individual SDK components you intend to use.\n\nFor the module builds, these are available in the following manner\n(replace <PACKAGE> with the name of a component - i.e. auth, database, etc):\n\nCommonJS Modules:\nconst firebase = require('firebase/app');\nrequire('firebase/<PACKAGE>');\n\nES Modules:\nimport firebase from 'firebase/app';\nimport 'firebase/<PACKAGE>';\n\nTypescript:\nimport firebase from 'firebase/app';\nimport 'firebase/<PACKAGE>';\n");
index_esm_default.registerVersion(name$1, version$1);
